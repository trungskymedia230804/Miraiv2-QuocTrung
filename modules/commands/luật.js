        ...
        default: {
            if (thisThread.listRule.length != 0) {
                ...
                return api.sendMessage(`==== Luật của nhóm ====\n━━━━━━━━━━━━━━━━━━\n
                    1. Không spam lệnh: tối đa 3 lệnh / 10s/người.
                    2. Không spam ký tự/ảnh/mention hàng loạt.
                    3. Nếu bot lỗi → ping admin, đừng spam lặp lại.
                    4. Nhóm hết hạn thuê sẽ bị chặn lệnh (hãy liên hệ admin để gia hạn).
