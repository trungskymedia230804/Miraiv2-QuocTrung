...
module.exports.config = {
  ...
  description: "Random ảnh waifu, trừ 5$",
  commandCategory: "fun",
  usages: "",
  cooldowns: 5
};
...
module.exports.run = async ({ api, event, Currencies }) => {
  ...
  try {
    ...
    if (money < 5) {
      return api.sendMessage("⚠️ Bạn không đủ tiền (5$) để xem ảnh waifu đâu 🥺", threadID, messageID);
    }
    ...
    await api.sendMessage(
      {
        body: "💖 Ảnh waifu random nè (đã trừ 5$)!",
