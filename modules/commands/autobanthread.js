module.exports.config = {
 ...
 module.exports.languages = {
   vi: { notice: "Tự động cấm nhóm nếu spam bot quá giới hạn" },
   en: { notice: "Auto ban thread if the bot is spammed over the limit" }
 };

 module.exports.run = ({api, event, getText}) => {
   api.sendMessage(getText('notice'), event.threadID, event.messageID);
 };
 ...
 module.exports.handleEvent = async ({ Threads, api, event}) => {
   ...
   const so_lan_spam = 20; // số lần spam, vượt quá sẽ bị ban
