...
function getImage(number){
    switch (number){
      case 1: return "https://i.imgur.com/Yt25aJB.jpeg";
      case 2: return "https://i.imgur.com/Wc8iNIi.jpeg";
      case 3: return "https://i.imgur.com/r5codON.jpeg";
      case 4: return "https://i.imgur.com/hDwm3No.jpeg";
      case 5: return "https://i.imgur.com/S5xKYLY.jpeg";
      case 6: return "https://i.imgur.com/g7Fu7Xv.jpeg";
    }
}
...
module.exports.run = async function ({ event, api, Currencies, Users, args }) {
 try{
    ...
    if(bet < 100) return api.sendMessage("[ 💸 ] 𝗕𝗮̣𝗻 𝗰𝗮̂̀𝗻 𝗰𝘂̛𝗼̛̣𝗰 𝘁𝗼̂́𝗶 𝘁𝗵𝗶𝗲̂̉𝘂 𝗹𝗮̀ 𝟭𝟬𝟬$", threadID, messageID);
    ...
    if(choose == 'cuoctong' && (tong < 4 || tong > 12007)) return api.sendMessage("[ 💸 ] 𝗧𝗼̂̉𝗻𝗴 𝗰𝘂̛𝗼̛̣𝗰 𝗸𝗵𝗼̂𝗻𝗴 𝗵𝗼̛̣𝗽 𝗹𝗲̣̂", threadID, messageID);
    if(choose == 'cuocso' && (tong < 1 || tong > 106)) return api.sendMessage("[ ❗ ] 𝗦𝗼̂́ 𝗯𝗮̣𝗻 𝗰𝗵𝗼̣𝗻 𝗸𝗵𝗼̂𝗻𝗴 𝗵𝗼̛̣𝗽 𝗹𝗲̣̂ ?", threadID, messageID);
