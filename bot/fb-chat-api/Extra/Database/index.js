...
if (!fs.existsSync(process.cwd() + '/Horizon')) {
    fs.mkdirSync(process.cwd() + '/Horizon');
    fs.writeFileSync(process.cwd() + '/Horizon/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/Horizon/SyntheticDatabase.sqlite");
